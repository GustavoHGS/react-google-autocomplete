  ...
  _createClass(ReactGoogleAutocomplete, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          rest = _objectWithoutProperties(_props2, ['onPlaceSelected', 'types', 'componentRestrictions', 'bounds', 'defaultValue']);
    ...
    value: function componentDidMount() {
      ...
      if (this.props.input.value) {
        ...
        this.placeService.getDetails({ placeId: this.props.input.value }, function (e, status) {
          if (status === 'OK') {
            _this4.refs.input.value = e.formatted_address || _this4.props.defaultValue;
          }
        });
      }
    }
